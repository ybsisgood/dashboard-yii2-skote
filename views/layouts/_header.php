        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?= $baseUrl; ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?= $baseUrl ?>/themes/skote/assets/images/logo.svg" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= $baseUrl ?>/themes/skote/assets/images/logo-dark.png" alt="" height="17">
                    </span>
                </a>

                <a href="<?= $baseUrl; ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?= $baseUrl ?>/themes/skote/assets/images/logo-light.svg" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= $baseUrl ?>/themes/skote/assets/images/logo-light.png" alt="" height="19">
                    </span>
                </a>
            </div>
